...
- **Day 2** : Find all patients admitted to 'Surgery' service with a satisfaction score below 70, showing their patient_id, name, age, and satisfaction score.[Code](./Codes_daywise/Day%202_IDC.sql)
